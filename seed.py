...
def seed():
    ...
    project = Project.objects.create(name="SEO Insight Pro", domain="https://seoinsightpro.com")
    ...
    for kw, rank, prev, vol, cpc, diff, intent, trend in keywords_data:
        Keyword.objects.create(
            project=project, keyword=kw, rank=rank, previous_rank=prev,
    ...
    print(f"Database seeded successfully with project: {project.name}")
